...
public class StudentInfoApplication {
	...
	public void createSubject() {
		//Subject(String subjectName, int subjecId)생성자
		//Define.KOREA: 과목코드
	...
	public void createStudent() {
		//학생 생성
		//Student(int studentId, String studentName, Subject majorSubject)생성자
		...
		//학생의 과목별 점수 추가
		//addScoreForStudent(Student student, Subject subject, int point)
	...
	public void addScoreForStudent(Student student, Subject subject, int point) {
		...
		//Student객체에서 ArrayList<Score> scoreList에 추가되는 메소드 호출
